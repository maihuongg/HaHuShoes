...
@WebServlet(urlPatterns = "/seller/product-management/add")
...
//		super.doGet(req, resp);
		...
		req.getRequestDispatcher("/views/seller/seller-add-product.jsp").forward(req, resp);
...
//		String date=curDate.toString();
		try {
			...
			String realPath = req.getServletContext().getRealPath("/HaHuShoes_Images");
...
//			product.setCreateDate(createDate);
			...
			resp.sendRedirect(req.getContextPath() + "/seller/product-management?username="+username+"");
