...
@WebServlet(urlPatterns = {"/admin/order-delivered"})
public class OrderDeliveredController extends HttpServlet{
	...
	protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		...
		int count = orderService.countAllOrderBeingDelivered();
		...
		List<OrderModel> orderList= orderService.findOrderBeingDelivered(index);
