			...
			<div class="row pb-3">
				...
				<div class="col-12 pb-1">
					<ul class="pagination pull-right">
						<c:if test="${tag>1}">
							<li class="page-item active"><a class="page-link" href="<c:url value="/searchproduct?index=${tag-1}&txtsearch=${txtsearch}"/>">Previous</a></li>
						</c:if>
						<c:forEach begin="1" end="${endP }" var="i">
							<li class='page-item ${tag == i ? "active":"" }'><a
								class="page-link" href="<c:url value="/searchproduct?index=${i}&txtsearch=${txtsearch}"/>">${i }</a>
							</li>
						</c:forEach>
						<c:if test="${tag<endP}">
							<li class="page-item active"><a class="page-link" href="<c:url value="/searchproduct?index=${tag+1}&txtsearch=${txtsearch}"/>">Next</a>
							</li>
						</c:if>
					</ul>
				</div>
