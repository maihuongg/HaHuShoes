			...
			<div class="row pb-3">
				...
				<div class="col-12 pb-1">
					<ul class="pagination pull-right">
						<c:if test="${tag>1}">
							<li class="page-item active"><a class="page-link" href="<c:url value="/shopprobycate?index=${tag-1}&cateId=${cateId}"/>">Previous</a></li>
						</c:if>
						<c:forEach begin="1" end="${endP }" var="i">
							<li class='page-item ${tag == i ? "active":"" }'><a
								class="page-link" href="<c:url value="/shopprobycate?index=${i}&cateId=${cateId}"/>">${i }</a>
							</li>
						</c:forEach>
						<c:if test="${tag<endP}">
							<li class="page-item active"><a class="page-link" href="<c:url value="/shopprobycate?index=${tag+1}&cateId=${cateId}"/>">Next</a>
							</li>
						</c:if>
					</ul>
				</div>
