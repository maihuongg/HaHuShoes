			...
			<div class="navbar-nav w-100">
				...
				<div class="nav-item dropdown">
					...
					<div class="dropdown-menu bg-transparent border-0">
						<a href="user-management" class="dropdown-item active">Users</a> <a
...
<div class="content">
	<div class="container-fluid pt-4 px-4">
			...
			<div class="d-flex align-items-center justify-content-between mb-4">
				...
				<div>
					<a type="button" class="btn btn-primary rounded-pill m-4"
						href="user-management/add">Add</a> <a id="statisticButton"
						type="button" class="btn btn-success rounded-pill m-2"
						data-toggle="modal" data-target="#chartModal">Statistics</a>
		...
		<div class="modal fade" id="chartModal" tabindex="-1" role="dialog"
			width="800" height="600" aria-labelledby="chartModalLabel"
			aria-hidden="true">
			<div class="modal-dialog modal-dialog-centered">
				<div class="modal-content">
					<div class="modal-header">
						<h5 class="modal-title" id="chartModalLabel">User Chart</h5>
					...
					<div class="modal-body">
						...
						<img src="${pageContext.request.contextPath}/imageChart/userChart.png"
							alt="Product Category Chart" width="460" height="400">
					</div>
