	...
	<div class="container-fluid pt-4 px-4">
		<div class="bg-secondary text-center rounded p-4">
			<div class="d-flex align-items-center justify-content-between mb-4">
				...
				<div>
					<a href= "${pageContext.request.contextPath }/admin/category-management" type="button" class="btn btn-success rounded-pill m-2">Exit</a>
				</div>
			</div>
		</div>
		<!-- Form Start -->
				...
				<div class="row g-4">
					<div class="col-sm-12 col-xl-6">
						<div class="bg-secondary rounded h-100 p-4">
							<h4 class="mb-4">Add Category Form</h4>
							...
							<form role="form" action="add" method="post"
								...
								<div class="mb-3">
									...
									<label class="form-label">Category Name</label> <input type="text"
										class="form-control" name="cateName">
								</div>
								<div class="mb-3">
									<label for="exampleInputEmail1" class="form-label"> Category Code </label> <input type="text" class="form-control"	name="cateCode">
								</div>
								<div class="mb-3">
