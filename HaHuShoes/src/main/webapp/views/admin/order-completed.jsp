		...
		<div class="container-fluid pt-4 px-4">
			<div class="bg-secondary text-center rounded p-4">
				<div class="d-flex align-items-center justify-content-between mb-4">
					...
					<div>
						<a type="button" class="btn btn-success rounded-pill m-2"
							href="order-management">Unprocessed Orders</a> 
							<a type="button" class="btn btn-success rounded-pill m-2"
							href="order-delivered">Orders are being delivered</a>
							<a type="button" class="btn btn-success rounded-pill m-2"
							href="order-completed">Completed Orders</a>
					</div>
				</div>
			</div>
			<div class="bg-secondary text-center rounded p-4">
						...
						<ul class="pagination pull-right">
							...
							<c:forEach begin="1" end="${endP }" var="i">
								<li class='page-item ${tag == i ? "active":"" }'><a
									class="page-link"
									href="<c:url value="/admin/dashboard?index=${i}"/>">${i }</a></li>
							</c:forEach>
							<c:if test="${tag<endP}">
								<li class="page-item active"><a class="page-link"
