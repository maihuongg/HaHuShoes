 ...
 <div class="container-fluid position-relative d-flex p-0">
        ...
        <div class="sidebar pe-4 pb-3">
            <nav class="navbar bg-secondary navbar-dark">
                <a href="${pageContext.request.contextPath }/admin/dashboard?username=${sessionScope.account.userName}" class="navbar-brand mx-4 mb-3">
				...
				<div class="row g-4">
					<div class="col-sm-12 col-xl-6">
						<div class="bg-secondary rounded h-100 p-4">
							<h2 class="mb-4">Information User Form</h2>
							...
							<form role="form" action="edit" method="post"
								...
								<div class="mb-3">
									<label class="form-label">Username</label> <input type="text"
										name="userName" value="${oneUser.userName} "readonly
										class="form-control">
								</div>
								<div class="mb-3">
									<label class="form-label">Fullname</label> <input type="text"
										name="fullName" value="${oneUser.fullName}"
										class="form-control">
								</div>
								<div class="mb-3">
								...
								<div class="mb-3">
									<label class="form-label">Password</label> <input
										type="password" name="password" value="${oneUser.password}"
										class="form-control">
								</div>
								<div class="mb-3">
